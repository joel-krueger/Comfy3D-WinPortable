...
3.1. If you are going to run Stable Fast 3D workflows, you need to edit the start script `run.bat`, find the line:
...
3.2. If you run multiple ComfyUI instances in Sandboxie, the `.bat` scripts should be executed in a sandbox.
